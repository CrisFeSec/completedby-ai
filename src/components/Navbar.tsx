  ...
  return (
    <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/50 backdrop-blur-xl border-b border-white/30 shadow-[0_4px_30px_rgba(108,92,231,0.06)]' : ''}`}>
      <div className="max-w-[980px] mx-auto px-6 flex items-center justify-between h-14">
        <a href="#" className="text-[24px] font-semibold text-[#1a1a2e]" style={{ fontFamily: "'Playfair Display', serif" }}>
          CompletedBy
        </a>
        <div className="hidden sm:flex items-center gap-7">
          ...
          <a href="#intake" className="text-[13px] font-medium text-white bg-primary hover:bg-primary-hover px-5 py-2 rounded-full transition-colors">Build My AI Employee</a>
        </div>
      </div>
    </nav>
  )
